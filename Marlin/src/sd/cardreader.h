...
public:
  ...
  static bool isPaused() { return isUSB_fileopen && !flag.sdprinting; }  //Elsan
  ...
  static uint8_t percentDone() {
    ...
    if (/*isFileOpen() && filesize*/1) return sdpos / ((filesize + 99) / 100);
    return 0;
  }
  ...
  static bool eof()              { return getIndex() >= getFileSize(); } //Elsan dis
  //static inline bool eof() { return sdpos >= filesize; }         //Elsan
