...
public:
  ...
  // Hook for "Change custom temperature ext"
  static void HandleCustomExtTemperatureChanged(DGUS_VP_Variable &var, void *val_ptr);
  // Hook for "Change custom temperature bed"
  static void HandleCustomBedTemperatureChanged(DGUS_VP_Variable &var, void *val_ptr);
  ...
  static void HandleHeaterControl(DGUS_VP_Variable &var, void *val_ptr);
    ...
    // Hook for filament load and unload init
    ...
    // Hook for SD filament load and unload filament option
    static void HandleSDFilamentOption(DGUS_VP_Variable &var, void *val_ptr);
    // Hook for SD filament load and unload
    static void HandleSDFilamentLoadUnload(DGUS_VP_Variable &var);
  #endif

  #if ENABLED(SDSUPPORT)
    static void DGUSLCD_SD_RefreshFilelist(DGUS_VP_Variable &var, void *val_ptr);
