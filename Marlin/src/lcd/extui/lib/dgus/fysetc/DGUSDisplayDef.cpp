...
const uint16_t VPList_SDPrintTune_Speed[] PROGMEM = {
  VP_Feedrate_Percentage,
  0x0000
};

const uint16_t VPList_SDPrintTune_Temp[] PROGMEM = {
  VP_T_E0_Is, VP_T_E0_Set,
  VP_T_Bed_Is, VP_T_Bed_Set,
  0x0000
};

const uint16_t VPList_SDPrintTune_Fan[] PROGMEM = {
  #if FAN_COUNT > 0
    VP_Fan0_Percentage, VP_FAN0_STATUS,
  #endif
  0x0000
...
const struct VPMapping VPMap[] PROGMEM = {
  ...
  { DGUSLCD_SCREEN_MOVEMENT_X, VPList_Status_X },
  { DGUSLCD_SCREEN_MOVEMENT_Y, VPList_Status_Y },
  { DGUSLCD_SCREEN_MOVEMENT_Z, VPList_Status_Z },
  { DGUSLCD_SCREEN_MOVEMENT_E, VPList_Status_E },
  ...
  { DGUSLCD_SCREEN_CALIBRATION_HEATING, VPList_Calibration_heating },
  { DGUSLCD_SCREEN_FIRST_LAYER_CAL, VPList_First_Layer_Calibration },
  ...
  { DGUSLCD_SCREEN_SDPRINTTUNE_SPEED, VPList_SDPrintTune_Speed },
  { DGUSLCD_SCREEN_SDPRINTTUNE_FAN, VPList_SDPrintTune_Fan },
  { DGUSLCD_SCREEN_SDPRINTTUNE_TEMP, VPList_SDPrintTune_Temp },
...
const char MarlinVersion[] PROGMEM = DETAILED_BUILD_VERSION;
...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
  ...
  #endif
  VPHELPER(VP_FAN_ON_OFF, nullptr, &DGUSScreenVariableHandler::HandleFanOnOff, nullptr),
  VPHELPER(VP_CALIBRATION_POINTS, nullptr, &DGUSScreenVariableHandler::HandleGoToCalibrationPoints, nullptr),
  VPHELPER(VP_MAX_POINTS, nullptr, &DGUSScreenVariableHandler::HandleGoToMaximumPoints, nullptr),
  VPHELPER(VP_MOTOR_LOCK_UNLOK, nullptr, &DGUSScreenVariableHandler::HandleMotorLockUnlock, nullptr),
  VPHELPER(VP_EEPROM_SAVE_RESTORE_SETTINGS, nullptr, &DGUSScreenVariableHandler::HandleEepromSaveRestoreSettings, nullptr),
  VPHELPER(VP_END_PREHEAT, nullptr, &DGUSScreenVariableHandler::HandleEndPreheat, nullptr),
    ...
    VPHELPER(VP_FIRST_LAYER_CALIBRATION, nullptr, &DGUSScreenVariableHandler::HandleFirstLayerCalibrationOption, &DGUSScreenVariableHandler::HandleFirstLayerCalibration),
  #endif
  ...
  // Temperature Data
    ...
    VPHELPER(VP_T_E0_Custom_Set, nullptr, DGUSScreenVariableHandler::HandleCustomExtTemperatureChanged, nullptr),
    ...
    VPHELPER(VP_E0_STATUS, &thermalManager.temp_hotend[0].target, nullptr, &DGUSScreenVariableHandler::DGUSLCD_SendHeaterStatusToDisplay),
      ...
      VPHELPER(VP_FILAMENT_LOAD_UNLOAD_INIT, nullptr, &DGUSScreenVariableHandler::HandleFilamentInit, nullptr),
      ...
      VPHELPER(VP_E0_FILAMENT_SD_LOAD_UNLOAD, nullptr, &DGUSScreenVariableHandler::HandleSDFilamentOption, &DGUSScreenVariableHandler::HandleSDFilamentLoadUnload),
      VPHELPER(VP_FILAMENT_LOAD_UNLOAD_CONFIRMATION, nullptr, &DGUSScreenVariableHandler::HandleFilamentConfirmation, nullptr),
    #endif
  #endif
  #if HOTENDS >= 2
    ...
    VPHELPER(VP_E1_FILAMENT_SD_LOAD_UNLOAD, nullptr, &DGUSScreenVariableHandler::HandleSDFilamentOption, &DGUSScreenVariableHandler::HandleSDFilamentLoadUnload),
  #endif
  #if HAS_HEATED_BED
    ...
    VPHELPER(VP_T_Bed_Custom_Set, nullptr, DGUSScreenVariableHandler::HandleCustomBedTemperatureChanged, nullptr),
  ...
  VPHELPER(VP_PrintProgress_Progressbar, nullptr, nullptr, DGUSScreenVariableHandler::DGUSLCD_SendPrintProgressBarToDisplay ),
  ...
  #if ENABLED(SKEW_CORRECTION)
    VPHELPER(VP_XY_DIAG_AC, nullptr, &DGUSScreenVariableHandler::HandleSkewVarsChanged, nullptr),
    VPHELPER(VP_XY_DIAG_BD, nullptr, &DGUSScreenVariableHandler::HandleSkewVarsChanged, nullptr),
    VPHELPER(VP_XY_SIDE_AD, nullptr, &DGUSScreenVariableHandler::HandleSkewVarsChanged, nullptr),
    VPHELPER(VP_XY_SKEW_CALC, nullptr, &DGUSScreenVariableHandler::HandleSkewVarsChanged, nullptr),
    VPHELPER(VP_XY_SKEW_FACTOR, &planner.skew_factor.xy, nullptr, DGUSScreenVariableHandler::DGUSLCD_SendFloatAsIntValueToDisplay<2>),
  #endif
  ...
  // SDCard File listing.
    ...
    VPHELPER(VP_SD_Refresh_List, nullptr, DGUSScreenVariableHandler::DGUSLCD_SD_RefreshFilelist, nullptr),
