...
void DGUSScreenHandler::DGUSLCD_SendHeaterStatusToDisplay(DGUS_VP_Variable &var) {
  ...
  /*void DGUSScreenHandler::DGUSLCD_SD_FileSelected(DGUS_VP_Variable &var, void *val_ptr) {
    ...
    //}
      ...
      // Send print filename
      dgusdisplay.WriteVariable(VP_SD_Print_Filename, buf_main[touched_nr+file_cnt3], VP_SD_FileName_LEN, true);
    #endif

    // Setup Confirmation screen
    file_to_print = touched_nr;
    HandleUserConfirmationPopUp(VP_SD_FileSelectConfirm, nullptr, PSTR("Print file"), buf_main[touched_nr+file_cnt3], PSTR("from SD Card?"), true, true, false, true);
  }*/
  ...
  /*void DGUSScreenHandler::DGUSLCD_SD_ResumePauseAbort(DGUS_VP_Variable &var, void *val_ptr) {
    ...
    switch (swap16(*(uint16_t*)val_ptr)) {
      ...
      case 1:  // Pause
        ...
        break;
      case 2:  // Abort                    
        ScreenHandler.HandleUserConfirmationPopUp(VP_SD_AbortPrintConfirmed, nullptr, PSTR("Abort printing"), buf_main[file_to_print+file_cnt3], PSTR("?"), true, true, false, true);
        break;
...
void DGUSScreenHandler::HandleHeaterControl(DGUS_VP_Variable &var, void *val_ptr) {
  ...
  *(int16_t*)var.memadr = *(int16_t*)var.memadr > 0 ? 0 : preheat_temp;
  ...
  void DGUSScreenHandler::HandleSDFilamentLoadUnload(DGUS_VP_Variable &var) {
    //SERIAL_ECHO_MSG("HandleSDFilamentLoadUnload");
