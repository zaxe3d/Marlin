...
enum DGUSLCD_Screens : uint8_t {
  ...
  DGUSLCD_SCREEN_MOVEMENT_Z          =  64,
  DGUSLCD_SCREEN_MOVEMENT_E          =  65,
  DGUSLCD_SCREEN_POWER_LOSS          = 248,
  DGUSLCD_SCREEN_MANUALMOVE          = 192,
  DGUSLCD_SCREEN_UTILITY             =  20,
  DGUSLCD_SCREEN_SDUTILITY           =  22,
  DGUSLCD_SCREEN_SD_FILAMENT_LOAD    =  23,
  DGUSLCD_SCREEN_SD_FILAMENT_UNLOAD  =  24,
  DGUSLCD_SCREEN_SD_FILAMENT_RUNOUT  =  25,
  DGUSLCD_SCREEN_FILAMENT_CONFIRM    =  26,
  DGUSLCD_SCREEN_FILAMENT_HEATING    = 106,
  DGUSLCD_SCREEN_FILAMENT_LOADING    = 108,
  DGUSLCD_SCREEN_FILAMENT_UNLOADING  = 117,
  DGUSLCD_SCREEN_MANUALEXTRUDE       = 160,
  DGUSLCD_SCREEN_SDFILELIST          = 202,
  DGUSLCD_SCREEN_SDPRINTMANIPULATION = 204,
