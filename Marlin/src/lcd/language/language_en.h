...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_START_PRINTING                  = _UxGT("Start Printing this file?");
  PROGMEM Language_Str MSG_ABORT_PRINTING                  = _UxGT("Cancel Printing this file?");
  ...
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_HOTEND          = _UxGT("EXTRUDER T. RUNAWAY");
