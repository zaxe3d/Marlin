...
/* External variables --------------------------------------------------------*/
//#include "stm32f4xx_hal.h"  //Elsan
#include "../../STM32F4xx_HAL_Driver/Inc/stm32f4xx_hal.h"   //Elsan
#include <stdio.h>
//#include <math.h>
...
{
  //SERIAL_ECHOPGM("OTG_HS_IRQHandler");
  //prnt_els("OTG_HS_IRQHandler");  //Elsan working no need to print.
