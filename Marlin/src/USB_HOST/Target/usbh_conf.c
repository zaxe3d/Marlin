...
#include "../../Drivers/STM32F4xx_HAL_Driver/Inc/stm32f4xx_hal.h"  //Elsan
#include "usbh_core.h"
//#include "../Drivers/STM32F4xx_HAL_Driver/Inc/stm32f4xx_hal_hcd.h"  //Elsan no help
...
USBH_StatusTypeDef USBH_LL_Init(USBH_HandleTypeDef *phost)
{
  ...
  hhcd_USB_OTG_HS.Init.lpm_enable = 0;
  ...
  if (phost->id == HOST_HS)
  {
    if (state == 0)
    {
      ...
      /* USER CODE BEGIN DRIVE_HIGH_CHARGE_FOR_HS */
    	HAL_GPIO_WritePin(GPIOE, /*GPIO_PIN_5*/GPIO_PIN_14, GPIO_PIN_RESET);
    ...
    else
    {
      ...
      /* USER CODE BEGIN DRIVE_LOW_CHARGE_FOR_HS */
    	HAL_GPIO_WritePin(GPIOE, /*GPIO_PIN_5*/GPIO_PIN_14, GPIO_PIN_SET);
