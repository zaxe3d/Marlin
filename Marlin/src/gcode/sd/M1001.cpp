...
void GcodeSuite::M1001() {
  ...
  // Update the status LED color
    ...
    if (long_print) {
      ...
      //TERN_(EXTENSIBLE_UI, ExtUI::onUserConfirmRequired(GET_TEXT_F(MSG_PRINT_DONE))); //Elsan dis
  ...
  //TERN_(EXTENSIBLE_UI, ExtUI::onPrintDone());   //Elsan empty.
  //TERN_(DWIN_LCD_PROUI, DWIN_Print_Finished()); //Elsan removed in new version.
