...
#include "../core/debug_out.h"
  ...
  bool MarlinSettings::save() {
    ...
    //
    {
      ...
      #else
        constexpr int16_t ui_preheat_hotend_temp[2] = { PREHEAT_PLA_HOTEND, PREHEAT_ABS_HOTEND },
                          ui_preheat_bed_temp[2]    = { PREHEAT_PLA_BED, PREHEAT_ABS_BED };
        constexpr uint8_t ui_preheat_fan_speed[2]   = { 0, 0 };
      #endif
...
void MarlinSettings::reset() {
  ...
  #if HOTENDS && HAS_LCD_MENU
    ui.preheat_hotend_temp[0] = PREHEAT_PLA_HOTEND;
    ui.preheat_hotend_temp[1] = PREHEAT_ABS_HOTEND;
    ui.preheat_bed_temp[0] = PREHEAT_PLA_BED;
    ui.preheat_bed_temp[1] = PREHEAT_ABS_BED;
    ui.preheat_fan_speed[0] = 0;
    ui.preheat_fan_speed[1] = 0;
  #endif
  ...
  void MarlinSettings::report(const bool forReplay) {
    ...
    CONFIG_ECHO_START();
    SERIAL_ECHOLNPAIR_P(
      PSTR("  Material Custom Temp (Ext/Bed): "), material.custom_temp.ext, " ",  material.custom_temp.bed
    );
