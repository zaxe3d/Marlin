...
class Temperature {
  ...
  public:
     ...
     */
      ...
      static constexpr inline uint8_t fanPercent(const uint8_t speed) { return ui8_to_percent(speed); } //Elsan
     ...
     */
    static void task();
    static void manage_heater(); // Added _O2 to work around a compiler error //Elsan
    ...
    static celsius_t degTargetHotend(const uint8_t E_NAME) {
      ...
      #endif
      static celsius_float_t degBed()  { Bed_temp=temp_bed.celsius; /*Elsan*/ return temp_bed.celsius; }
