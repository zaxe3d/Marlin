...
//
  ...
  #define HEATER_CHAMBER_PIN      PB10 //P2_04   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
  //#define HEATER_CHAMBER_INVERTING true //false
  #define FAN1_PIN                   PB10 //-1   // Remove the fan signal on pin P2_04 (example: SKR 1.4 Turbo HE1 plug)

  #define CHAMBER_FAN               // Enable a fan on the chamber
  #if ENABLED(CHAMBER_FAN)
    //#define CHAMBER_FAN_INDEX     2   // Index of a fan to repurpose as the chamber fan. (Default: first unused fan)
    #define CHAMBER_FAN_MODE      1 //2   // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve; 3=similar to 1 but fan is always on.
...
#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 10 //0
 ...
 */
  ...
  #define PROBING_MARGIN_BACK   25 //PROBING_MARGIN
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     35 //10  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      480 //100  // (mm) The length of filament for a complete unload.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   35 //6  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     400 //0  // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     1 //0  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_RSENSE         0.10     // Multiplied x1000 for TMC26X
    ...
    #define E0_CURRENT      850 //800
    #define E0_MICROSTEPS    16
    #define E0_RSENSE         0.22 //0.11
  ...
  #define  Y_SLAVE_ADDRESS 1 //0
  #define  Z_SLAVE_ADDRESS 2 //0
  ...
  #define X_HYBRID_THRESHOLD    150 //100  // [mm/s]
  #define X2_HYBRID_THRESHOLD   100
  #define Y_HYBRID_THRESHOLD    150 //100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD      6 //3
